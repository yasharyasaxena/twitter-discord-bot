...
if not BRANDS_TO_MONITOR:
    raise ValueError("No brands specified to monitor. Please set the BRANDS_TO_MONITOR environment variable.")
...
class TwitterDiscordBot:
    ...
    def get_tweets_by_user_id(self, user_id, since_time=None, max_results=10):
